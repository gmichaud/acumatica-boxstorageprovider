...
namespace PX.SM.BoxStorageProvider
{
    public class BoxBlobStorageProvider : IPXFileAttachmentProvider
    {
        ...
        public void AddFile(Guid noteID)
        {
            ...
            throw new PXRedirectToUrlException("https://app.box.com/embed_widget/000000000000/files/0/f/" + folderID, PXBaseRedirectException.WindowMode.New, "Box.com Folder");
        }
        ...
        public string GetEditUrl(Guid fileID)
        {
            ...
            return "https://app.box.com/embed_widget/000000000000/files/0/f/" + file.ParentFolderID + "/1/f_" + file.ID;
        }
